# Contributing to action-update-semver

We love your input! 🚀 We want to make contributing to this project as easy and transparent as possible, whether it's:

- [Reporting a bug](https://github.com/rickstaa/action-update-semver/issues).
- [Discussing the current state of the code](https://github.com/rickstaa/action-update-semver/discussions).
- [Submitting a fix](https://github.com/rickstaa/action-update-semver/pulls).
- [Proposing new features](https://github.com/rickstaa/action-update-semver/issues).
...
## Report bugs using Github's [issues](https://github.com/rickstaa/action-update-semver/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/rickstaa/action-update-semver/issues/new/choose); it's that easy!
